# Introduction
My own stubborn preference for an art/artist distinction makes this introduction acutely painful to write. This project, in particular, is one that I sought to keep ambiguous, to allow for multiple valid interpretations. Alas, there is also value in understanding how the artist thought about their art, even if only to start a discourse on how to better achieve artistic goals in future projects.
